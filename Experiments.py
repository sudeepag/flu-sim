"""
Runs the experiments detailed in the paper. This is a simple script to use the optimizer to find optimal interventions.
"""
...
def test_dim():
    ...
    for dim in range(10, 110, 10):
        ...
        vecs.append((np.mean([v[0] for v in best_vecs]), np.mean([v[1] for v in best_vecs]),
